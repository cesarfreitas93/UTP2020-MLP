...
\author{\IEEEauthorblockN{1\textsuperscript{st} Pierre Alexander Filio Ramírez}
\IEEEauthorblockA{\textit{Universidad Tecnológica del Perú} \\
\textit{Facultad de Ingeniería}\\
Lima, Perú \\
1629136@utp.edu.pe}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Denisse Rebeca Luque Condori}
\IEEEauthorblockA{\textit{Universidad Tecnológica del Perú} \\
\textit{Facultad de Ingeniería}\\
Lima, Perú \\
1525501@utp.edu.pe}
\and
\IEEEauthorblockN{3\textsuperscript{rd} César Alberto Freitas Cespedes}
\IEEEauthorblockA{\textit{Universidad Tecnológica del Perú} \\
\textit{Facultad de Ingeniería}\\
Lima, Perú \\
u18306877@utp.edu.pe}
}
...
La economía peruana tiene la mayor parte de su producción basada en pequeñas y medianas empresas, según el ministerio de producción este segmento empresarial representa el 99,5% del total de empresas formales en la economía peruana. , en estas empresas los recursos escasean y se resuelven los problemas con base en la experiencia de los emprendedores, el propósito de este trabajo es presentar una aplicación de las redes neuronales en pronósticos de producción mensuales basados en datos de ventas mensuales a fin de mejorar las decisiones de los emprendedores que manejan las MYPES peruanas, dejando claro que un pronostico es solo una aproximación a la realidad.
...
Se uso la técnica de redes neuronales multicapa perceptrón , configurado con 3 capas , y con una tasa de aprendizaje de 0.01, con datos del mercado peruano en el periodo 2010 l 2016 a partir de datos de la Superintendencia del Mercado de Valores (SMV, 2017), Para el entrenamiento de la red neuronal artificial se utilizó un 80% de casos aleatorios y para las pruebas el 20% restante, ajustándose los parámetros sobre la base de los mejores resultados obtenidos con un promedio de ajuste usando el algoritmo de Gerson (Gerson, 1991) para determinar la importancia de las características de entrada.
...
\begin{figure}[htbp]
\centerline{\includegraphics{img/figuran.png}}
\caption{Example of a figure caption.}
\label{fig}
\end{figure}
